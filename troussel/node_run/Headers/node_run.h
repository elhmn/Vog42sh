...
void	execute(t_cmd *dat, t_env *env, int pip[2][2], int swtch);/*configure les fd et execute le binaire désigné par dat ou, le builtin, dans ce cas la fonction appel exit avec la valeur de retour du builtin*/
